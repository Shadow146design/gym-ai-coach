const MUSCLE_STYLES = [
  { keys: ["poitrine", "pec", "chest"], color: "var(--rust)", bg: "var(--rust-bg)", icon: "🎯" },
  { keys: ["dos", "dorsal", "back"], color: "var(--steel-soft)", bg: "rgba(79,122,138,.15)", icon: "🔙" },
  { keys: ["épaule", "epaule", "shoulder"], color: "var(--gold)", bg: "var(--gold-bg)", icon: "🏋️" },
  ...
  { keys: ["biceps", "triceps", "bras", "avant-bras", "arm"], color: "var(--rust-soft)", bg: "rgba(229,106,68,.12)", icon: "💪" },
  { keys: ["abdo", "core", "abs", "gainage"], color: "var(--steel)", bg: "rgba(79,122,138,.12)", icon: "🔥" },
  { keys: ["cardio", "full body", "full-body", "corps entier"], color: "var(--red)", bg: "rgba(217,64,64,.12)", icon: "⚡" },
];
